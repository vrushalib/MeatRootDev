...
public class EditNewsletterAction extends BaseAction
{
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            setNewsletterBool(kkAppEng.getCustomerMgr().getCurrentCustomer().getNewsletter().equals("1")?true:false);

            kkAppEng.getNav().add(kkAppEng.getMsg("header.newsletter.subscriptions"), request);
    ...
    /**
     * @param newsletterBool the newsletterBool to set
     */
