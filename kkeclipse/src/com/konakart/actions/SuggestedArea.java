...
public class SuggestedArea extends BaseAction
{
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            {
        		com.konakart.db.KKBasePeer.executeStatement("insert into suggested_areas (emailid, pincode) values ('"+emailId+"', '"+pinCode+"');", org.apache.torque.Torque.getConnection("store1", "root", "root123"));
                return SUCCESS;
            }
