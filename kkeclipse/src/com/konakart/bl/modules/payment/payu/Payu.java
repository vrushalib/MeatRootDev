...
public class Payu extends BasePaymentModule implements PaymentInterface
{
    ...
    private final static String MODULE_PAYMENT_PAYU_ZONE = "MODULE_PAYMENT_PAYU_ZONE";
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        staticData.setZone(getConfigurationValueAsIntWithDefault(MODULE_PAYMENT_PAYU_ZONE,
                0));
