...
<% com.konakart.al.KKAppEng kkEng = (com.konakart.al.KKAppEng) session.getAttribute("konakartKey");  %>
	    		...
	    		<div class="content-area rounded-corners">
		    		<div id="about-us">
		    	<p align="justify">	
			Welcome to the mecca of meat lovers! 
			<br><br>MeatRoot opened its doors in June 2014 bringing in the Meat on Wheels concept to life, at your
			...
			home. 
			<br><br>We deliver you the freshest, firmest and the best quality meat
			...
			meat products. 
			<br><br>The entire process of choosing meat, getting it
			...
			<br><br>So whether you're working late,
